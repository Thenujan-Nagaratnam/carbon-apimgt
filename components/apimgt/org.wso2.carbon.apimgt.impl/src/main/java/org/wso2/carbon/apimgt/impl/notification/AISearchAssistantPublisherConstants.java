 ...
 */
public class AISearchAssistantPublisherConstants {
    ...
    public final static String SWAGGER_DEFINITION = "swagger_definition";
    ...
    public final static String NOTIFICATION_TYPE_NEW_VERSION = "lifecycle_change";
