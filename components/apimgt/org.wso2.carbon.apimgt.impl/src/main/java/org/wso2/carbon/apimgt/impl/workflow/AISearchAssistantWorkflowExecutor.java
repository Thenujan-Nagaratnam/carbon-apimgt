 ...
 * 
 */
public class AISearchAssistantWorkflowExecutor extends WorkflowExecutor {
    private static final Log log = LogFactory.getLog(AISearchAssistantWorkflowExecutor.class);
    @Override
