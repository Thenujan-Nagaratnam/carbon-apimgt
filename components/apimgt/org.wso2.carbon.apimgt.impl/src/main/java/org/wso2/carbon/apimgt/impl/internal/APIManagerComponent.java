...
public class APIManagerComponent {
    ...
    protected void activate(ComponentContext componentContext) throws Exception {
        ...
        try {
            ...
            String isMarketplaceAssistantEnabled = configuration.getFirstProperty(APIConstants.MARKETPLACE_ASSISTANT_ENABLED);
            ...
            if (Boolean.parseBoolean(isMarketplaceAssistantEnabled)) {
